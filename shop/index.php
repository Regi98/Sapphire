...
<html lang="en">
	<head>
	    ...
	    <title>Sapphire DTX | Home Page</title>
...
?>
		...
		<div class="col-6 col-sm-6 col-md-4 wow fadeInUp">
			...
			<div class="image"> -->
				<div class="card">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>" class="card-img-top"><img src="assets/images/blank.gif" data-echo="../../inflightapp/storage/app/public/product_images/<?php echo htmlentities($row['product_image_1']);?>" alt="" class="img-fluid" width="100%" height="100%"></a>
			<!-- </div> --><!-- /.image -->			                      		   
		<!-- </div> --><!-- /.product-image -->
