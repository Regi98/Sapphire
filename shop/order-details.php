				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="../../inflightapp/storage/app/public/product_images/<?php echo $row['pimg1'];?>" alt="" width="84" height="146">
						</a>
					</td>
					...
					<td>
 <a href="javascript:void(0);" onClick="popUpWindow('http://localhost/shopping/track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order"></a>
					Track</td>
				</tr>
<?php $cnt=$cnt+1;} } else { ?>
