...
{
$sql=mysqli_query($con,"SELECT password FROM  shopusers where password='".md5($_POST['cpass'])."' && id='".$_SESSION['id']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update shopusers set password='".md5($_POST['newpass'])."', updationDate='$currentTime' where id='".$_SESSION['id']."'");
...
?>
														...
														<form class="register-form" role="form" method="post">
															<div class="form-group">
																<label class="info-title" for="name">First Name
																	<span>*</span>
																</label>
															...
															<div class="form-group">
																<label class="info-title" for="name">Last Name
																	<span>*</span>
																</label>
									...
									<div id="collapseTwo" class="panel-collapse collapse">
										<div class="panel-body">
											...
											<form class="register-form" role="form" method="post" name="chngpwd" onSubmit="return valid();">
												<div class="form-group">
													<label class="info-title" for="Current Password">Current Password
														<span>*</span>
													</label>
