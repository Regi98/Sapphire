				...
				<div class="cart-item product-summary">
					<a style="text-decoration:none;" href="product-details.php?pid=<?php echo htmlentities($row['id']);?>">
						<div class="row">
							<div class="col-4">
								<div class="image">
									<img  src="../../inflightapp/storage/app/public/product_images/<?php echo $row['product_image_1'];?>" width="30" height="35" alt="">
								</div>
							</div>
							<div class="col-7">
								<h3 class="name"><?php echo $row['product_name']; ?></h3>
								<div class="price">$<?php echo ($row['product_price']); ?>x<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
							</div>
