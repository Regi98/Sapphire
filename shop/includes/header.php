      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          ...
          <div class="right-menu list-inline no-margin-bottom">
            ...
            <!-- Megamenu end     -->
            <!-- Languages dropdown    -->
         <div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><span style="font-size:16.5px;" class="d-none d-sm-inline-block"><?php echo htmlentities($_SESSION['name']);?></span></a>
              <div aria-labelledby="languages" class="dropdown-menu">
                <a rel="nofollow" href="#" class="dropdown-item"><span>E-Wallet: </span><span class="pull-right"><img src="../img/dollar.png" width="20px"> &nbsp; $0.00</span></a>
