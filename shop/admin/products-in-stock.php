...
<head>
	...
	<title>Admin | Product In Stock</title>
...
<?php include('include/sidebar.php');?>				
	...
	<div class="module">
							<div class="module-head">
								<h3>Manage Products In Stock</h3>
							</div>
...
?>									
										<tr>
											...
											<td><?php echo htmlentities($row['product_in_stock']);?></td>
										<td><?php $st=$row['product_in_stock'];
                                            if($st == 0)
                                            {
                                                echo "Out of Stock";
                                            }
										 ...
										 ?></td>
										<td><button class="btn btn-primary in-stock" title="Edit Quantity">Edit In Stock</button></td>
						...
						action: function () {
							...
							if (!product_stock) {
								...
								$.confirm({
									...
									content: '<strong>Product:</strong> ' + product_name + '<br><strong>In Stock:</strong> ' + product_stock,
									buttons: {
										Yes: {
											btnClass: 'btn-green',
											action: function () {
												$.ajax({
													...
													data: {
														productId: product_id, inStock: product_stock
													},
													dataType: "text",
