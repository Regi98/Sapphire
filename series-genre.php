...
<div class="container-fluid">
        ...
        elseif ($main_genre == 4) {
            echo'<h8 class="my-content">Drama TV Shows</h8>';
        }
        elseif ($main_genre == 5) {
            echo'<h8 class="my-content">Horror TV Shows</h8>';
        }
        elseif ($main_genre == 6) {
            echo'<h8 class="my-content">Romantic TV Shows</h8>';
        }
        elseif ($main_genre == 7) {
