...
<?php include('includes/header.php');?>
				...
				<div class="body-content outer-top-xs">
					<div class="container">
						<div class="row inner-bottom-sm" style="border: 1px solid black">
													...
													<tr>
														...
														<td class="cart-image">
															<a class="entry-thumbnail" href="detail.html">
																<img src="../../inflightapp/storage/app/public/product_images/<?php echo $row['pimg1'];?>" alt="" width="84" height="84">
															</a>
														</td>
