				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="../../inflightapp/storage/app/public/product_images/<?php echo $row['product_image_1'];?>" alt="" width="114" height="105">
						</a>
					</td>
...
$_SESSION['sid']=$pd;
					...
					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo "$"." ". ($_SESSION['cart'][$row['id']]['quantity']*$row['product_price']); ?>.00</span></td>
				</tr>
...
<div class="col-4 cart-shopping-total mt-3 text-left">
	<table class="table">
		<thead>
			<tr>
				<th>
		...
		<tbody>
				<tr>
					<td>
						...
						<button type="submit" name="ordersubmit" class="btn btn-block btn-primary checked">PROCCED TO CHEKOUT</button>	
						</div>
					</td>
				</tr>
