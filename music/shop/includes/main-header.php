...
<div class="logo">
	<a href="index.php">
		<img src="assets/images/logo.png" width="300" height="55">
	</a>
</div>		
</div>
...
<?php }
				...
				<div class="col-xs-12 col-sm-12 col-md-3 animate-dropdown top-cart-row pull-right">
			...
			<li>
				<div class="cart-item product-summary">
					<div class="row">
						<div class="col-xs-4">
							<div class="image">
								<a href="detail.html"><img  src="../../inflightapp/storage/app/public/product_images/<?php echo $row['product_image_1'];?>" width="30" height="35" alt=""></a>
							</div>
						</div>
						<div class="col-xs-7">
							
							<h3 class="name"><a href="index.php?page-detail"><?php echo $row['product_name']; ?></a></h3>
							<div class="price">$<?php echo ($row['product_price']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
