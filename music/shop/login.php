...
$query=mysqli_query($con,"insert into shopusers(firstname,lastname,email,password) values('$firstname','$lastname','$email','$password')");
if($query)
{
...
if(isset($_POST['login']))
{
   $email=$_POST['email'];
   $password=md5($_POST['password']);
$query=mysqli_query($con,"SELECT * FROM shopusers WHERE email='$email' and password='$password'");
...
<html lang="en">
	<head>
	    ...
	    <title>Sapphire DTX | Signi-in | Signup</title>
...
<div class="form-group">
	    	<label class="info-title" for="firstname">FirstName <span>*</span></label>
	    	<input type="text" class="form-control unicase-form-control text-input" id="firstname" name="firstname" required="required">
	  	</div>

	  	<div class="form-group">
	    	<label class="info-title" for="lastname">LastName <span>*</span></label>
